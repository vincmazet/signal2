...
alors le filtre est à {ref}`réponse impulsionnelle finie (RIF)<P:filtrage:rif>`.
Dans le cas contraire, on parle de filtre à {ref}`réponse impulsionnelle infinie (RII)<P:filtrage:rii>`.
