...
```{figure} schema-tansf-bilineaire.svg
:height: 180px
```
...
1. Un [filtre analogique](C:filtrage:analogiques) est conçu à partir de ce gabarit analogique :
