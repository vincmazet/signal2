...
```{figure} td-rf-expfigs-ex3.svg
```

### Exercice 4

```{figure} td-rf-expfigs-ex4.svg
```

### Exercice 5

```{figure} td-rf-expfigs-ex5.svg
```
...
```{figure} td-rf-expforme-directe-sys3.svg
---
width: 450px
```
...
```{figure} td-rf-expfigs-ex16-analogique.svg
```
...
```{figure} td-rf-expforme-directe-sys4.svg
---
width: 100%
```
