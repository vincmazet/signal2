...
Enfin, la quatrième partie présentent des techniques pour synthétiser des filtres numériques ([RII](C:filtrage:rii) ou [RIF](C:filtrage:rif)) et [analogiques](C:filtrage:analogiques).
